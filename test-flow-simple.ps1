...
$quoteResponse = Invoke-RestMethod -Uri "http://localhost:4000/api/quotes" -Method POST -ContentType "application/json" -Headers @{"Authorization" = "Bearer $clientToken"} -Body '{"notes": "Need supplies for hotel renovation"}'
